          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _StatusBadge(status: delay.status),
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        ...
                        if (onDelete != null && delay.status == 'pending') ...[
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Wrap(
                        spacing: 6,
                        runSpacing: 6,
                        children: delay.classes.map((className) {
                          return Container(
